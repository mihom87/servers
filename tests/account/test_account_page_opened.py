...
def test_account_page_opened(driver, account_page_opened):
    """
    Verify that navigation to account page works correctly.

    PRECONDITIONS:
        - User must be logged in
        - Account page navigation is performed

    ACTION:
        - Navigate to account page from dashboard

    CHECK:
        - User is redirected to account page
        - Account page URL is correct
    """
